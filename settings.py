...
FPS = 60
MAX_FRAME_DT = 0.1  # сек - жёсткий потолок кадра, чтобы лаги/сворачивание окна не пробивали стены
UI_HEIGHT = 40
...
ANIMAL_FROZEN_DISAPPEAR_TIME = 45.0
...
# ---------- Мясо ----------
MEAT_LIFETIME = 20.0
MEAT_PLACEMENT_AMOUNT_MIN = 15
MEAT_PLACEMENT_AMOUNT_MAX = 40
...
AUTOSAVE_INTERVAL_SECONDS = 180.0  # период фонового автосохранения мира (если включено в настройках)
...
MINIMAP_SIMULATION_AREA_ALPHA = 70  # затемнение всего, что вне ДОС/зоны видимости Избранного
MINIMAP_STATIC_REFRESH_MS = 500  # как часто перерисовывать статические слои мини-карты (деревья, кусты, вода...)

# ---------- Избранное существо (звезда) ----------
FAVORITE_STAR_COLOR = (255, 215, 0)
FAVORITE_STAR_COLOR_HOVER = (255, 230, 90)
FAVORITE_STAR_BORDER = (120, 95, 0)
FAVORITE_STAR_HOLLOW_BORDER = (90, 90, 90)
FAVORITE_STAR_HOLLOW_HOVER = (150, 150, 150)
MINIMAP_FAVORITE_STAR_SIZE = 5
...
# ---------- Универсальное поведение животных ----------
...
ANIMAL_URGENT_DIRECT_RANGE = 50
ANIMAL_LAND_RESCUE_RADIUS = 1500
...
ANIMAL_FLEE_STUCK_CHECK_INTERVAL = 0.6      # как часто проверяем "а мы вообще сдвинулись, убегая?"
ANIMAL_FLEE_STUCK_MOVE_RATIO = 0.15         # если за интервал сдвинулись меньше этой доли дистанции - считаем, что зажаты
ANIMAL_FLEE_STUCK_ESCAPE_MULTIPLIER = 1.6   # аварийный рывок в сторону, если реально зажаты в угол
...
ANIMAL_RIVER_SWIM_SPEED_MULTIPLIER = 0.5
