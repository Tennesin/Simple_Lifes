...
from settings import BIOME_PLAINS, BIOME_DESERT, BIOME_RIVER
from .ci_settings import (
    HP_MAX, HUNGER_MAX, THIRST_MAX, SANITY_MAX, ENERGY_MAX, SPEED,
    GENDER_FEMALE, LIFE_STAGE_OLD, STATE_SLEEP,
    BASE_HUNGER_INTERVAL, BASE_THIRST_INTERVAL,
    HEALING_HUNGER_INTERVAL, HEALING_THIRST_INTERVAL,
    STARVING_HUNGER_INTERVAL, STARVING_THIRST_INTERVAL,
    DESERT_THIRST_DRAIN_MULTIPLIER, DESERT_ENERGY_DRAIN_MULTIPLIER,
    METABOLISM_LIFE_STAGE_MULTIPLIER, METABOLISM_TEMPERAMENT_MULTIPLIER,
    METABOLISM_STATE_MULTIPLIER, PREGNANCY_METABOLISM_MULTIPLIER,
    SANITY_DECAY_INTERVAL, NAMED_SANITY_DECAY_MULTIPLIER, PUBERTY_SANITY_DECAY_MULTIPLIER,
    SANITY_STATE_DECAY_MULTIPLIER, CLOSE_FRIEND_SANITY_RELATIONSHIP,
    ENERGY_DRAIN_INTERVAL, ENERGY_SLEEP_RESTORE_RATE, ENERGY_FORCED_SLEEP_RESTORE_RATE,
    ENERGY_STATE_MULTIPLIER, ENERGY_TEMPERAMENT_MULTIPLIER, PREGNANCY_ENERGY_MULTIPLIER,
    OLD_ENERGY_DRAIN_MULTIPLIER, HOME_ENERGY_DRAIN_MULTIPLIER,
    DEATH_CAUSE_STARVATION, DEATH_CAUSE_SANITY,
    PANIC_SPEED_MULTIPLIER, PREGNANCY_SPEED_MULTIPLIER, RIVER_SWIM_SPEED_MULTIPLIER,
)
