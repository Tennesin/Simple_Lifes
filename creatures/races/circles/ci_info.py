...
INFO_CREATURE_GOAL_CHILD_HUNGER_GO_HOME = "Идёт домой, там его покормят"
INFO_CREATURE_GOAL_CHILD_AWAIT_FEEDING = "Останавливается, чтобы взрослый успел покормить"
...
INFO_CREATURE_GOAL_IDLE_GO_HOME = "Возвращается домой, пока нет других дел"
INFO_CREATURE_GOAL_IDLE_AT_HOME = "Отдыхает дома"
INFO_CREATURE_GOAL_SLEEP_FORCED = "Без сил, спит прямо тут"
INFO_CREATURE_GOAL_SLEEP_FIRE = "Спит у костра"
INFO_CREATURE_GOAL_SLEEP_GO_HOUSE = "Идёт домой, чтобы поспать"
INFO_CREATURE_GOAL_SLEEP_AT_HOME = "Спит дома, в безопасности"
INFO_CREATURE_GOAL_HOUSE_EVICTED = "Покинул родительский дом - пора своего"
...
INFO_SETTINGS_MINIMAP_HOUSES = "Показать дома (и их склады) на мини-карте"

# --------------------- Объекты и механики, специфичные для расы 'Круг' ---------------------
INFO_BTN_DRAW_CHILD_ROAD = "Детская дорога"
INFO_BTN_HOUSE = "Дом"
INFO_BTN_CAMPFIRE = "Костёр"
INFO_BTN_CREATE_MALE = "Круг (М)"
INFO_BTN_CREATE_FEMALE = "Круг (Ж)"
...
INFO_INFO_HOUSE_INSIDE_NOW = "Внутри сейчас: {names}"
INFO_INFO_HOUSE_INSIDE_EMPTY = "Внутри сейчас: Пусто"
