...
from settings import (
    FONT_NAME, FONT_SIZE_TITLE, FONT_SIZE_LABEL, FONT_SIZE_SMALL,
    WORLD_SCREEN_MARGIN, WORLD_SCREEN_BG, WORLD_SCREEN_TEXT,
    WORLD_SCREEN_HINT_COLOR, WORLD_SCREEN_ERROR_COLOR,
    WORLD_SCREEN_PANEL_BG, WORLD_SCREEN_PANEL_BORDER,
    WORLD_LIST_ITEM_HEIGHT, WORLD_LIST_ITEM_COLOR,
    WORLD_LIST_ITEM_HOVER_COLOR, WORLD_LIST_ITEM_SELECTED_COLOR,
    WORLD_DEFAULT_SIZE, MINIMAP_BIOME_COLOR,
    BUTTON_COLOR, BUTTON_HOVER, CLOSE_BUTTON_COLOR, CLOSE_BUTTON_HOVER, TEXT_COLOR,
)
from info import (
    INFO_WS_SCREEN_TITLE, INFO_WS_TITLE_NAME, INFO_WS_TITLE_SEED, INFO_WS_TITLE_SIZE,
    INFO_WS_LENGTH, INFO_WS_WIDTH, INFO_WS_GENERATE_ANIMALS, INFO_WS_TITLE_BIOME_RATIOS,
    INFO_BTN_WS_CREATE, INFO_BTN_BACK,
    INFO_LW_SCREEN_TITLE, INFO_LW_EMPTY_LIST, INFO_LW_SELECT_HINT, INFO_LW_CONFIRM_DELETE,
    INFO_BTN_LW_LOAD, INFO_BTN_LW_DELETE,
    INFO_LW_INFO_NAME, INFO_LW_INFO_CREATED, INFO_LW_INFO_VERSION, INFO_LW_INFO_SIZE,
    INFO_LW_INFO_SEED, INFO_LW_INFO_CREATURES, INFO_LW_INFO_FRUITS, INFO_LW_INFO_SPIKES,
    INFO_LW_INFO_WATER, INFO_LW_INFO_BUSHES, INFO_LW_INFO_CAMPFIRES, INFO_LW_INFO_ROADS,
    INFO_LW_INFO_ANIMALS_TOTAL, INFO_LW_INFO_ANIMAL_TYPE,
)
